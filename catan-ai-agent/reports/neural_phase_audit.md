...
```json
{
  "pytest_q_output": "........................................................................ [ 82%]\n...............                                                          [100%]\n87 passed in 69.72s (0:01:09)",
  "pytest_neural_output": "..........................                                               [100%]\n26 passed in 27.87s",
  "full_pass_count": 87,
  "target_pass_count": 26,
...
- **PASS** `Policy loss drops substantially` — before=2.0007, after=1.9161
- **PASS** `Value loss drops substantially` — before=0.9782, after=0.0002
...
{
  "num_samples_used": 64,
  "initial_policy_loss": 2.000749349594116,
  "final_policy_loss": 1.9161381721496582,
  "initial_value_loss": 0.9782044887542725,
  "final_value_loss": 0.0001881204079836607,
  "top1_agreement_before": 0.734375,
  "top1_agreement_after": 0.84375,
...
```json
{
  "raw_access_references": [
    ...
    },
    {
      "file": "tests/test_policy_value.py",
      "line": 334,
      "text": "acting = game.state.current_color()"
    },
    {
      "file": "tests/test_policy_value.py",
      "line": 336,
      "text": "ctx = DecisionContext(game, game.playable_actions, acting)"
    }
  ],
...
- **PASS** `NeuralMCTS (priors/value off) matches plain MCTS, or explained` — diff is expected: NeuralMCTS uses PUCT selection while plain MCTS uses UCT
- **PASS** `Enabling priors/value changes root ranking or visit distribution on fixed state`
  ...
  "fixed_state_comparisons": [
    {
      ...
      "visit_distribution_changed_with_model": true,
      "ranking_or_visits_changed_with_model": true,
      "model_active": true,
      "plain": {
        "chosen_encoded_action": "BLUE:BUY_DEVELOPMENT_CARD",
        "chosen_raw_action": "Action(color=C.BLUE, action_type=AT.BUY_DEVELOPMENT_CARD, value=None)",
        "top5_root_actions": [
          [
            "BLUE:BUY_DEVELOPMENT_CARD",
            {
              "visits": 22,
              "avg_value": 0.1203
            }
      ...
      "neural_on": {
        ...
        "root_value_estimate": 0.7621307969093323
      }
    },
    {
      "seed": 778,
      ...
      "acting_color": "BLUE",
      "legal_ok": true,
      "off_matches_plain": false,
      "ranking_changed_with_model": true,
      "visit_distribution_changed_with_model": true,
      "ranking_or_visits_changed_with_model": true,
      "model_active": true,
      "plain": {
        "chosen_encoded_action": "BLUE:MOVE_ROBBER(((-2,0,2),RED))",
        "chosen_raw_action": "Action(color=C.BLUE, action_type=AT.MOVE_ROBBER, value=((-2, 0, 2), C.RED))",
        "top5_root_actions": [
          [
            "BLUE:MOVE_ROBBER(((-2,0,2),RED))",
            {
              "visits": 11,
              "avg_value": 0.1297
            }
      ...
      "neural_on": {
        ...
        "root_value_estimate": 0.9643182754516602
      }
    },
    {
      "seed": 779,
      ...
      "neural_on": {
        "chosen_encoded_action": "BLUE:MOVE_ROBBER(((0,-1,1),RED))",
        "chosen_raw_action": "Action(color=C.BLUE, action_type=AT.MOVE_ROBBER, value=((0, -1, 1), C.RED))",
        "top5_root_actions": [
          [
            "BLUE:MOVE_ROBBER(((0,-1,1),RED))",
            {
        ...
        "root_value_estimate": 0.9971385598182678
      }
    }
  ]
}
...
- **PASS** `No obvious END_TURN spam in buildable states` — {"rate": 0.00044169611307420494, "end_turn_while_build_city_or_settlement": 4, "total_decisions": 9056}
- **PASS** `Arena results reproducible under fixed seeds` — first=(8, 0, 0) repeat=(8, 0, 0)
...
```json
{
  ...
  "pathology_counters": {
    "end_turn_while_build_city_or_settlement": 4,
    "total_decisions": 9056
  }
}
```
...
- **FAIL** `Priors are not uniformly flat on most states` — max_probs=[0.018518518656492233, 0.1419047713279724, 0.2804430425167084, 0.22996872663497925, 0.23286738991737366, 0.5324612259864807, 0.317187637090683, 0.3506639003753662, 0.3001701235771179, 0.05555630847811699]
- **PASS** `Priors vary across states` — max_probs=[0.018518518656492233, 0.1419047713279724, 0.2804430425167084, 0.22996872663497925, 0.23286738991737366, 0.5324612259864807, 0.317187637090683, 0.3506639003753662, 0.3001701235771179, 0.05555630847811699]
  ...
  "state_rows": [
    {
      ...
      "value_prediction": -0.9934751987457275
    },
    {
      "meta": {
        "game_id": 0,
      ...
      "value_prediction": -0.9999927878379822
    },
    {
      "meta": {
        "game_id": 0,
    ...
    },
    {
      ...
      "value_prediction": 0.9999974966049194
    },
    {
      "meta": {
        "game_id": 0,
      ...
      "pred_top5": [
        ...
        [
          "BLUE:MARITIME_TRADE((WHEAT,WHEAT,WHEAT,WHEAT,WOOD))",
          0.09589286893606186
        ],
        [
    ...
    },
    {
      ...
      "value_prediction": -0.9999716877937317
    },
    {
      "meta": {
        "game_id": 1,
      ...
      "value_prediction": -0.9998649954795837
    },
    {
      "meta": {
        "game_id": 1,
      ...
      "value_prediction": -0.9999997019767761
    },
    {
      "meta": {
        "game_id": 1,
      ...
      "value_prediction": 0.9999542832374573
    },
    {
      "meta": {
        "game_id": 1,
      ...
      "value_prediction": 0.9999977946281433
    }
  ]
}
```
...
- Model output quality audit
  - Priors are not uniformly flat on most states: max_probs=[0.018518518656492233, 0.1419047713279724, 0.2804430425167084, 0.22996872663497925, 0.23286738991737366, 0.5324612259864807, 0.317187637090683, 0.3506639003753662, 0.3001701235771179, 0.05555630847811699]
...
- Fixed NeuralMCTS prior influence: model priors now order unexpanded actions before progressive widening expansion.
- Updated fixed-state audit probes to require branchable root states and check ranking or visit-distribution changes.
